...
Clone the repo:
```sh
git clone https://github.com/kBearXD-Team/taiwan_shrimp
cd taiwan_shrimp
```
...
export MONGO_HOST=mongodb://localhost/express-mongoose-es6-rest-api-development
...
## License
This project is licensed under the [MIT License](https://github.com/orgs/kBearXD-Team)


## Meta

kBearXD Inc. – [@kBearXD-Team](https://github.com/orgs/kBearXD-Team)
